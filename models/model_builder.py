...
class MoCo(nn.Module):
    ...
    def forward(self, sen_q, sen_k=None, is_eval=False, cluster_result=None, index=None, print_index=0, must_links_l=None, must_links_r=None, margin_info=False):
        """
        Input:
        ...
        if margin_info:
            ...
            logits = []
            for ids, (a_input_ids, a_attention_mask, a_e1_pos, a_e2_pos, a_aug_pos, p_input_ids, p_attention_mask, p_e1_pos, p_e2_pos, p_aug_pos) in enumerate(zip(sen_q[0], sen_q[1], sen_q[3], sen_q[4], sen_q[5], sen_k[0], sen_k[1], sen_k[3], sen_k[4], sen_k[5])):
